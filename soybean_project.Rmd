...
Soybean is key ingredient in multiple household food items like tofu, edamame, tempeh, miso, soy sauce, and soy milk. However, most of the soybean that is produced is used to feed animals like cows (~70%). This is just one example of a resource that could be greatly conserved if humans ate at lower trophic levels if we consumed soy products and other food items like corn and grains directly rather than feeding them to animals. 
